                                        ...
                                        <table align="left" cellpadding="2" cellspacing="2">
                                            ...
                                            <tr align="left">
                                                ...
                                                <td width="70%">
                                                    ...
                                                    <font color="red" size="-4">*Req</font>
                                                </td>
                                            </tr>
                                            <tr align="left">
                                            ...
                                            <tr align="left">
                                                ...
                                                <td width="70%">
                                                    <input name="add1" type="text" id="add1" size="30" value="Optional" />
                                                </td>
                                            </tr>
                                            <tr align="left">
                                                <td width="30%">Address 2: </td>
                                                <td width="70%">
                                                    <input name="add2" type="text" id="add2" size="30" value="Optional" />
                                                </td>
                                            </tr>
                                            <tr align="left">
                                                <td width="30%">Zip/Postal code: </td>
                                                <td width="70%">
                                                    <input name="zip" type="text" id="zip" size="30" value="Optional" />
                                                </td>
                                            </tr>
                                            <tr align="left">
                                                <td width="30%">City: </td>
