    ...
    <tr>
        <td align="center" valign="middle" class="black_note">
            <form action="index.php?filename=title_check" method="post">
                <center>
                    <p>Enter the article title in the box below to check against our database.</p>
                    <input type="text" name="art_title" size="60" style="font-family: verdana; font-size: 11px; color: #333333; border: 1px solid #C0C0C0" value="">
                    <br /><br />
            ...
            <form action="index.php?filename=body_check" method="post">
                <center>
                    <p>Enter the part of the article body text you'd like to check in the box below.  It is not necessary to
                        enter in the entire article.   A sentence or paragraph is usually sufficient.</p>
                    <textarea rows="5" name="art_text" cols="60" style="font-family: verdana; font-size: 11px; color: #333333; border: 1px solid #C0C0C0"></textarea>
                    <br /><br />
                    <input type="submit" />
                </center>
            </form>
            ...
            <center>Enter a phrase, sentence or title, then choose the search engine to search on.<br /><br />
