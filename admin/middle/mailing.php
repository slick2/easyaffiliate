...
<table border="0" width="75%">
                     ...
                     <tr>
                      ...
                      <tr><td align="center" colspan="2">
                        <input type="submit" value="Send HTML To All Authors" name="Submit" onClick="return confirmsubmit();"></form><br><br></td>	
                     ...
                     <option value="60">60 Seconds</option>
                      ...
                      <tr><td align="center" colspan="2"><input type="submit" value="Send PlainText To All Authors" name="Submit2" onClick="return confirmsubmits();"></form></td>
                      </tr>
                      <tr><td>&nbsp;</td></tr>
