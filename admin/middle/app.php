...
?>
<center><table border="0" align="center" cellpadding="10" cellspacing="2">
<tr>
  <td><font size="2">You may edit keywords for each category by choosing each category from the dropdown list. <font color="red">**Important**</font>
 &nbsp;&nbsp;If you <b>add new categories</b>, be sure to add keywords for each new category before approving articles by keywords!<br>
 &nbsp;&nbsp;You can edit forbidden Keywords at the bottom of the dropdown menu list.</font></td>
<tr></table><br>
...
<FORM action="<? print "index.php?filename=app";?>" method="POST">
<input type="hidden" name="add" value="<? print $add; ?>">
<input type="hidden" name="operation" value="<? if (isset($kwds)) {print "update";} else {print "add";} ?>">
<p><font size="2"><b>You are in the "<? print $cat[$add]; ?>" category now!</b><br>Enter your word or phrase separated by a comma and a space after the comma.<br>
...
?>
  <tr>
    <td width="100%" valign="top">
<center><a href="index.php?filename=approve">Click here to approve all articles by your keywords</a></center><br><br>
