...
if ($num_rows > 0) {
    ...
    print "<br><br><center><font color='red'><b>No articles to process</b></font><br><br><a href='index.php?filename=app'>Back</a>";
    exit;
}
...
if ($result1) {
    ...
    print "<br><br><center><font color='red'><b>No keywords in DB</b></font><br><br><a href='index.php?filename=app'>Back</a>";
    exit;
}
...
if ($num_rows2 > 0) {
    ...
    print "<br><br><center><font color='red'><b>No keywords in DB</b></font><br><br><a href='index.php?filename=app'>Back</a><br></center>";
    exit;
}
...
//check for bad words
    ...
    $countkwinart = 0;
    foreach ($badkw as $tmpkw) {
        $countkwinart+=substr_count($tmp[text], $tmpkw);
    }
    if ($countkwinart > 0) {
        ...
        if ($updresult == 0) {
            print "Bad article not deleted!!!<br>";
        } else {
            print "Article deleted.<br>";
            $badart++;
        }
    } else {
