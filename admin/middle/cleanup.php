...
<?php
$k = 0;
if ($del_emptyintID !== false && $del_emptyintID != "") {
    echo "<p class='pad'>Number of Articles with no ID number: " . $del_emptyintID . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyintID . " Articles with a bad ID number.</p>";
}
if ($del_emptycatnum !== false && $del_emptycatnum != "") {
    echo "<p class='pad'>Number of Articles with no Category ID number: " . $del_emptycatnum . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptycatnum . " Articles with a bad Category ID number.</p>";
}
if ($del_emptyintAuth !== false && $del_emptyintAuth != "") {
    echo "<p class='pad'>Number of Articles with no Author ID number: " . $del_emptyintAuth . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyintAuth . " Articles with a bad Author ID number.</p>";
}
if ($del_emptyart_title !== false && $del_emptyart_title != "") {
    echo "<p class='pad'>Number of Articles with no Title: " . $del_emptyart_title . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyart_title . " Articles with a missing title.</p>";
}
if ($del_emptyart_summary !== false && $del_emptyart_summary != "") {
    echo "<p class='pad'>Number of Articles with no Summary: " . $del_emptyart_summary . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyart_summary . " Articles with a missing Summary.</p>";
}
if ($del_emptyart_body !== false && $del_emptyart_body != "") {
    echo "<p class='pad'>Number of Articles with no Text Body: " . $del_emptyart_body . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyart_body . " Articles with a missing Text Body.</p>";
}
if ($del_emptyauth_id !== false && $del_emptyauth_id != "") {
    echo "<p class='pad'>Number of Articles with no Author ID: " . $del_emptyauth_id . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyauth_id . " Articles with a missing Author ID.</p>";
}
if ($del_emptyauth_email !== false && $del_emptyauth_email != "") {
    echo "<p class='pad'>Number of Authors with no Author Email: " . $del_emptyauth_email . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyauth_email . " Authors with a missing Author Email.</p>";
}
if ($del_emptyauth_password !== false && $del_emptyauth_password != "") {
    echo "<p class='pad'>Number of Authors with no Author Password: " . $del_emptyauth_password . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyauth_password . " Authors with a missing Author Password.</p>";
}
if ($del_emptyauth_country !== false && $del_emptyauth_country != "") {
    echo "<p class='pad'>Number of Authors with no Author Country (Fixed): " . $del_emptyauth_country . "</p>";
} else {
    echo "<p  class='pad'>Found " . $del_emptyauth_country . " Authors with a missing Country ID.</p>";
}
if ($strays !== false && $strays != "") {
    echo "<p class='pad'>Number of Articles with no Author (Removed): " . $strays . "</p>";
} else {
    echo "<p  class='pad'>Found 0 Articles with a missing Author.</p>";
}
