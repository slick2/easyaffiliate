...
" . $title;
        ...
        <center>
            <font size="2">Please choose the reason for denying the article<br /><br />
        ...
        <table width="625"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left" width="2%">
                    From:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="user_from2" MAXLENGTH="50" SIZE="40" value="<?php echo $fromemail ?>" />
                </td>
            </tr>
            <tr>
                <td>
                    Subject:&nbsp;&nbsp;<input type="text" name="user_subject2" MAXLENGTH="50" SIZE="40" value="Article Declined" />
                </td>
            ...
            <tr>
                ...
                <td align="left">
                    <textarea name="user_message2" cols="75" rows="10">ADMIN NOTE: Overwrite this text is you'd like to add additional info to this decline email.  If you'd like to edit the email text sent, the file is admin/middle/deleteemail.php.  The reasons for declining articls is in your admin/deny.txt If you donot wish to include any additional text in your decline email, simply select and delete all this text.</textarea>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td align="center" colspan="2"><input type="submit" value="Send PlainText Email" name="Submit2" /></td>
            </tr>
        </table>
