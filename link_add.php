                            ...
                            <tr>
                                <td align="center" valign="top" class="inputlabel">
                                    <form name="links" action="links_submit.php" method="POST"><strong>
                                            <br />
                                            <br />
                                            Please fill out all fields, then click "Submit" and we will review your link asap!</strong>
                                        <br />
                                        <br />
                                        <br />
                                        <table border="0" width="75%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <input type="text" name="user_lname" MAXLENGTH="50" SIZE="40" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">Your Email:</td>
                                                <td align="left">
                                                    <input type="text" name="user_email" MAXLENGTH="50" SIZE="30" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">Your Sites Name</td>
                                                <td align="left">
                                                    <input type="text" name="site_name" MAXLENGTH="75" SIZE="40" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">Site Address:</td>
                                                <td align="left">
                                                    <input type="text" name="site_addy" MAXLENGTH="75" SIZE="40" value="http://" />
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <textarea readonly="yes" cols="50" rows="8"><?php require_once('linktxt.php') ?></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
