...
<form name="form11" method="post" action="">
	 <table  border="0" cellspacing="1" cellpadding="1" class="greyborder" align="center">
      ...
      <tr>
        <td style='font-weight:bold;'> <div align="left">First Name : </div></td>
      </tr><tr>
        <td><input name="fname" type="text" id="country19" value="<?=$FirstName;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">Last Name : </div></td>
        </tr><tr>
        <td><input name="lname" type="text" id="country20" value="<?=$lastName;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">Address Line 1 : </div></td>
        </tr><tr>
        <td><input name="add1" type="text" id="country21" value="<?=$Address1;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">Address Line 2 : </div></td>
        </tr><tr>
        <td><input name="add2" type="text" id="country22" value="<?=$Address2;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">Zip Code : </div></td>
        </tr><tr>
        <td><input name="zip" type="text" id="country23" value="<?=$Zip;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">City : </div></td>
        </tr><tr>
        <td><input name="city" type="text" id="country24" value="<?=$City;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">State : </div></td>
        </tr><tr>
        <td><input name="state" type="text" id="country25" value="<?=$State;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'> <div align="left">Country : </div></td>
        </tr><tr>
...
$result = select_pdo($query);
      ...
      <tr>
        <td style='font-weight:bold;'> <div align="left">Phone Number : </div></td>
        </tr><tr>
        <td><input name="phone" type="text" id="country26" value="<?=$Phone;?>" size="45"></td>
      </tr>
      <tr>
        <td style='font-weight:bold;'><div align="left">Fax Number : </div></td>
        </tr><tr>
        <td><input name="fax" type="text" id="country27" value="<?=$Fax;?>" size="45"></td>
      </tr>
       <tr>
                          <td width="39%" align="left" style='font-weight:bold;'>A little about you:</td>
                          </tr><tr>
                          <td width="58%" ><textarea name=message wrap=physical cols=45 rows=5 onKeyDown="textCounter(this.form.message,this.form.remLen,300);" onKeyUp="textCounter(this.form.message,this.form.remLen,300);"><?php echo $old_bio; ?></textarea>
<br>
<input readonly type=text name=remLen size=3 maxlength=3 value="300"> characters left</td>
                        </tr>
                         <tr>
                          <td width="39%" align="left" style='font-weight:bold;'>Your Website:</td>
                          </tr><tr>
                          <td width="58%"><input name="web" type="text" id="web" size="45" value="<?php echo $old_web ?>"></td>
                        </tr>
      <tr>
        <td>&nbsp; </td>
        <td>&nbsp;</td>
