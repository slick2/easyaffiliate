                        ...
                        <form name="form11" method="post" action="">
                            <table  width="90%" border="0" cellspacing="1" cellpadding="1" class="greyborder" align="center">
                                ...
                                <tr>
                                    <td> Article Title : </td>
                                    <td>
                                        <input name="title" type="text" id="title" size="50" value="<?php echo convert($ArticleTitle); ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"> Summary : </td>
                                    <td>
                                        <textarea name="summery" cols="39" rows="4" id="summery"><?php echo convert($Summary); ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td> Keywords : </td>
                                    <td>
                                        <input name="keywords" type="text" id="keywords" size="50" value="<?php echo convert($Keywords); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"> Article Text : </td>
                                    <td>
                                        <textarea name="textarea" cols="39" rows="6"><?php echo convert($ArticleText); ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"> Resources : </td>
                                    <td>
                                        <textarea name="resources" cols="39" rows="6" id="resources"><?php echo convert($Resource); ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
