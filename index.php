...
require_once("system/config.inc.php");
  ...
  if($pdo)
  {
  $query = "SELECT tblarticles.intId AS artid1, tblarticles.intCategory, tblarticles.intAuthorId, tblarticles.intStatus,
  tblarticles.varArticleTitle, tblarticles.ttSubmitDate, tblauthor.varFirstName, tblauthor.varlastName
  FROM tblarticles, tblauthor where (tblarticles.intStatus = ? AND tblauthor.txtBAN = 'No' AND tblarticles.intAuthorId = tblauthor.intId)
  ...
  tblarticles.varArticleTitle, tblarticles.ttSubmitDate, tblauthor.varFirstName, tblauthor.varlastName
  FROM tblarticles, tblauthor where (tblarticles.intStatus = 1 AND tblauthor.txtBAN = 'No' AND tblarticles.intAuthorId = tblauthor.intId)
...
<?php
      ...
      <div class="left">  
        ...
        <div class="right_side">  
          <div class="article">  
            <!-- Change index text below -->  <h2>Welcome To The 
              <?php echo $title; ?></h2>  <h3>Fresh Article Publishing</h3>  
            <p>
              <img src="images/books_cut.jpg" alt="pile of books" style='float:left;'/>You are looking at the new AF Free Version of our basic 
              article directory script for PHP & Mysql. 
            </p>  
            <p> This version has many changes, such as it's abililty to detect and use the PDO and PDO_Mysql drivers if installed on your hosting, otherwise 
          ...
          <div class="article">  <h2>Newest Articles</h2>  <h3>Click the link to view</h3>  
          </div>  
          <div class="grey_top">
          </div>  
          <div class="grey">
