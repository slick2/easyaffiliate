...
/////////////////////////////////////////////////////////////
  ...
  {
  $_SESSION['msg'] = "You old password is not a match for updating, <br>
  Please go back and enter your old password.";
  header("location:thankyou.php");
  die();
  }
          ...
          <div class="article"><h2>Change Password</h2>
            ...
            <table  border="0" cellspacing="1" cellpadding="1" class="greyborder" align="center">      
              ...
              <tr>        <td> Old Password : </td>        <td>
                  <input name="old_pass" type="text" id="country19" value="" size="30"></td>      
              </tr>      
              <tr>        <td> New Password : </td>        <td>
                  <input name="new_pass" type="text" id="country20" value="" size="30"></td>      
              </tr>      
              <tr>        <td> Confirm Password : </td>        <td>
                  <input name="cpass" type="text" id="country21" value="" size="30"></td>      
              </tr>      
              <tr>        <td>&nbsp; </td>        <td>&nbsp;</td>      
              </tr>      
              <tr>        
