...
<?php
    ...
    ?>
    <meta NAME="KEYWORDS" CONTENT="CONTENT="article directory script,article friendly,php mysql script,article script">
<?php
}
    ?>
...
<html><head><title><?php echo $title; ?> | <?php echo $artname ?></title></head><body><h3><?php echo $artname ?></h3><br><br> By: <?php echo $authorname ?><br><br><?php echo $arttext ?><br><br> <b>Author Resource:-></b>&nbsp;&nbsp;<?php echo $html; ?><br><br><?php echo "<b>Article From</b> <a href='".$site_URL."'>".$title."</a>"; ?><br></body></html>
</textarea>
              </p><br />
              <center>
