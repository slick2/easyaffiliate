        ...
        <div class="right_side">  
          <div class="article"><h2>Learn More</h2>
            ...
            <p>When you set up your 
              ...
              <?php echo $title; ?> :               
              <ul>              
                <li><strong>Skyrocket the incoming links pointing to your website - </strong>Search engines love links.                They use links as a gauge for determining how "important" your website is. Search engines view each link                pointing to your site as a "vote" and the more votes your website receives, the higher the rankings!               
                <li><strong>Dramatically boost your website traffic, sales, and newsletter optins - </strong>When you                submit articles to 
                <?php echo $title; ?>, your articles are picked up by other websites, featured in                newsletters, and sent out in ezines. This will create additional traffic and result in more exposure!               
                ...
                <li>Use the articles in our directory on your website to provide your visitors with more useful content                and keep them coming back for more.               
                <li>Use our articles on your blog to keep it fresh and updated daily with great information.               
