...
<div class="box_top">
  ...
  <div class="box">
  <p><a href='signup.php' <?php if($page == 'signup'){echo 'class="location"';} ?>>Signup</a></p>
  <p><a href='learnmore.php' <?php if($page == 'learnmore'){echo 'class="location"';} ?>>Learn More</a></p>
  <p><a href='terms.php' <?php if($page == 'terms'){echo 'class="location"';} ?>>Terms Of Service</a></p>
  <p><a href='top_authors.php' <?php if($page == 'top'){echo 'class="location"';} ?>>Top Articles</a></p>
  <p><a href='aboutus.php' <?php if($page == 'about'){echo 'class="location"';} ?>>About Us</a></p>
  <p><a href='privacy.php' <?php if($page == 'privacy'){echo 'class="location"';} ?>>Privacy Policy</a></p>
